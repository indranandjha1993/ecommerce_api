...
export const animations = {
  ...
  slideInLeft: 'slide-in-left 0.3s ease-in-out',
  slideOutLeft: 'slide-out-left 0.3s ease-in-out',
  slideInUp: 'slide-in-up 0.3s ease-in-out',
  slideOutDown: 'slide-out-down 0.3s ease-in-out',
